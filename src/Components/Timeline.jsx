...
const Timeline = () => {
  ...
  return (
    ...
    <div className="flex flex-col max-w-4xl mx-auto p-5 m-3 relative">
      <div className="p-8 m-10">
        <div className="flex gap-2 absolute top-0 ">
          {posts
            .filter((post) => {
              return (
                post.username !== "laura_jackson" &&
                post.username !== "emma_white" &&
                post.username !== "ryan_cooper" &&
                post.username !== "jessica_hall" &&
                post.username !== "daniel_smith" &&
                post.username !== "laura_jackson" &&
                post.username !== "olivia_miller"
              );
            })
            .map((post) => {
              return (
